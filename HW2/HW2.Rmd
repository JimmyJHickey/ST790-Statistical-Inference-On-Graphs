...
pairs(Xhat$vectors[,1:n_eigenvec], col = rep(c(4,7,9), each = 1100))

eigen = data.frame(Xhat$vectors[,1:n_eigenvec], y = as.factor(inlabels))
svmfit = svm(y ~ ., data = eigen, kernel = "linear", cost = 10, scale = FALSE)
plot(svmfit, eigen)
