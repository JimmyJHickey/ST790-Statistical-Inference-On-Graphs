...
Xhat2 <- embed_laplacian_matrix(lcc, type = "I-DAD", which = "sa", no = 3, scaled = FALSE)
...
Download the USPS digits dataset from [here](https://cs.nyu.edu/~roweis/data.html). Next do the following steps.
